...
import USDRevenue from '@/components/revenue/USDRevenue';
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center bg-muted rounded-lg p-1">
            <button 
              className={`px-3 py-1 rounded-md text-sm font-medium ${activeTab === 'overview' ? 'bg-background text-foreground shadow-sm' : 'text-muted-foreground'}`}
              onClick={() => setActiveTab('overview')}
            >
              Overview
            </button>
            <button 
              className={`px-3 py-1 rounded-md text-sm font-medium ${activeTab === 'usd' ? 'bg-background text-foreground shadow-sm' : 'text-muted-foreground'}`}
